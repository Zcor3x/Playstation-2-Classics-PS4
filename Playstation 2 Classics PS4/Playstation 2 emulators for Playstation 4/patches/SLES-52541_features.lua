-- Lua 5.3
-- Title: Grand Theft Auto: San Andreas - SLES-52541 (Europe) v2.01
...
local USEWIDESCREEN_ADDRESS = 0x7005ef
...
local hook2 = eeObj.AddHook(0x246840, 0x24040012, H2)	-- <TheGame(void)>:
